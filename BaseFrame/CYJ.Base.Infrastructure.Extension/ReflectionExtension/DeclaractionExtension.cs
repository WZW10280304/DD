...
{
    public static class DeclaractionExtension
    {
        ...
        public static string GetDeclaraction(this FieldInfo @this)
        {
            ...
            else if (@this.IsInitOnly) sb.Append("readonly ");
        ...
        internal static void GetDeclaraction(this ParameterInfo @this, StringBuilder sb)
        {
            ...
            var typeName = elementType != null
                ? @this.ParameterType.Name.Replace(elementType.Name, elementType.GetShortDeclaraction())
                : @this.ParameterType.GetShortDeclaraction();
